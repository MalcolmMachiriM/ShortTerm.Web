...
namespace ShortTerm.Web.Controllers.SystemVariables
{
    public class CitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,City,Id,DateCreated,DateModified")] Cities cities)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,City,Id,DateCreated,DateModified")] Cities cities)
        {
            if (id != cities.Id)
            {
                return NotFound();
